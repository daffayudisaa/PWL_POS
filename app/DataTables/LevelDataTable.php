    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addcolumn('action', function($row){
                $action = '<a href="m_level/edit/'.$row->level_id.'" class="edit btn-primary  btn-sm">Edit</a>';
                $action .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
                $action .= '<a href="m_level/delete/'.$row->level_id.'" class="delete btn-danger  btn-sm">Delete</a>';
                return $action;
            });
    }
